...
const customFormMaxFee = document.getElementById('customFormMaxFeeInput');
const customFormMaxPriority = document.getElementById('customFormMaxPriorityFeeInput');
      ...
      const session = await wcV2Modal.connect({
        requiredNamespaces: {
          eip155: {
            ...
            chains: ['eip155:' + connectWCV2ChainId.value],
